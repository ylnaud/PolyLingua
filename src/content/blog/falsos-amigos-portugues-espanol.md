...
El portugués suena a español, se escribe casi como español y comparte
gran parte de su vocabulario con el español. Eso genera una falsa
sensación de seguridad: creés que entendés todo, y de repente una palabra
que jurarías conocer significa algo completamente distinto — a veces con
resultados incómodos, a veces directamente graciosos.

## Por qué el portugués tiene tantos falsos amigos

Portugués y español evolucionaron del mismo latín vulgar en la misma
península, casi en paralelo durante siglos. Esa cercanía hace que miles de
palabras coincidan — pero también que algunas se separaran justo lo
suficiente como para significar otra cosa, conservando una forma casi
idéntica a la española.

El problema no son las palabras raras — son las **cotidianas**, las que
...
que está **avergonzada**. Y si alguien te dice que la fiesta estuvo
"esquisita", no la está elogiando: la está describiendo como **rara**.

**El más peligroso de escribir mal: "ano" vs "año".** En portugués, "año"
(la unidad de tiempo) se escribe **ano**, sin la eñe — porque el portugués
no tiene esa letra. El problema es que en español "ano" (sin eñe) significa
otra cosa completamente distinta. Este es el error tipográfico más famoso
del portugués: nunca escribas "ano" en español para referirte a un año, y
al escribir en portugués recordá que ahí "ano" sí es simplemente "year".
...
de **jamón y queso**. Y si pedís un "copo de água", te van a traer un
**vaso** de agua, no un copo de nieve.

_Cadeira_ engaña por parecido visual con "cadera": en portugués es
simplemente **silla**. "Sente-se nesta cadeira" significa "sentate en esta
silla", no tiene nada que ver con tu cadera.
...
- Alguien te dice que está "embaraçada" y vos entendés lo contrario de lo
  que te está contando.
- Te ofrecen "brincar" con los chicos y dudás si te están invitando a
  saltar o a jugar — es lo segundo.
