...
language: 'de'
level: 'a2'
title: 'German Modal Verbs: können, müssen, wollen, dürfen, sollen, möchten'
description: 'Master the six German modal verbs and their irregular conjugation, plus the rule that sends the main verb to the end of the sentence.'
order: 2
unit: 1
...
quiz:
  - question: 'Which modal verb expresses ability, like the English "can"?'
    ...
    answerIndex: 1
    explanation: 'Können means "can / to be able to": Ich kann gut schwimmen. (I can swim well.)'
  - question: 'What is the correct "ich" form of "müssen" (must / have to)?'
    options: ['ich müsse', 'ich musst', 'ich muss', 'ich müssen']
    answerIndex: 2
  ...
  - question: 'What does "möchten" express?'
    options: ['A strict obligation', 'A polite wish, "would like to"', 'Pure ability', 'Permission']
    answerIndex: 1
    explanation: 'Möchten is the polite, softened form used for wishes and requests: Ich möchte einen Kaffee. (I would like a coffee.)'
  - question: 'Which modal verb is closest in meaning to "should / to be supposed to"?'
    options: ['wollen', 'können', 'sollen', 'dürfen']
    answerIndex: 2
  ...
  - question: 'Which pair correctly shows the du-form of "können"?'
    options: ['du kannst', 'du könnst', 'du kannen', 'du können']
    answerIndex: 0
    explanation: 'The du-form of können is du kannst — note the vowel change (a, not ö) shared with the ich/er forms.'
exercises:
  - type: 'fill-blank'
    sentence: 'Ich ___ gut schwimmen.'
    answer: 'kann'
    accepted: ['Kann']
    hint: 'Können = ability. The ich-form drops the -en ending and loses the umlaut: kann, not könne.'
    translation: 'I can swim well.'
    placeholder: 'kann / muss / will'
  - type: 'fill-blank'
    sentence: 'Du ___ jetzt gehen.'
    answer: 'musst'
    accepted: ['Musst']
    hint: 'Müssen in the du-form: du musst (no umlaut, -st ending).'
    translation: 'You have to go now.'
    placeholder: 'musst / kannst / darfst'
  - type: 'match'
    instructions: 'Match each modal verb with its meaning.'
    pairs:
      - left: 'können'
        right: 'to be able to / can'
      - left: 'müssen'
        right: 'to have to / must'
      - left: 'dürfen'
        right: 'to be allowed to / may'
      - left: 'sollen'
        right: 'should / to be supposed to'
      - left: 'möchten'
        right: 'would like to'
  - type: 'write'
    prompt: 'Complete: "Ihr ___ hier nicht rauchen." (You all are not allowed to smoke here.)'
    answer: 'dürft'
    accepted: ['Dürft']
    hint: 'Dürfen in the ihr-form: ihr dürft.'
    placeholder: 'dürft / könnt / müsst'
  - type: 'write'
    prompt: 'Complete: "Ich ___ einen Kaffee." (I would like a coffee.)'
    answer: 'möchte'
    accepted: ['Möchte']
    hint: 'Möchten is the polite "would like" form — ich möchte, not ich will (which sounds more blunt/demanding).'
    placeholder: 'möchte / muss / kann'
  - type: 'order'
    sentence: 'Wir wollen ins Kino gehen'
    translation: 'We want to go to the cinema.'
vocabulary:
  - term: 'können'
...
German has six **modal verbs** — small verbs that modify the meaning of another verb
(ability, obligation, permission, desire) rather than describing an action themselves.
You'll use them constantly, so getting comfortable with their irregular conjugation
pays off fast.
...
Modal verbs are irregular, but they follow one shared pattern: most of them lose their
...
```
[Modal verb, position 2]  ...  [main verb infinitive, end]
```
