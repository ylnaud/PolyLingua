...
language: 'de'
level: 'a2'
title: 'The Perfekt Tense: How Germans Talk About the Past'
description: 'Learn the Perfekt (haben/sein + past participle), the tense Germans actually use in speech for past events, with regular and irregular participles.'
order: 1
unit: 1
...
quiz:
  ...
  - question: 'What is the past participle of the regular (weak) verb "spielen" (to play)?'
    options: ['gespielt', 'gespielen', 'spielt', 'gesplielt']
    answerIndex: 0
    explanation: 'Regular verbs form the participle with ge- + stem + -t: spiel + t = gespielt.'
  - question: 'Which verb does NOT get a ge- prefix in the Perfekt?'
    options: ['machen', 'studieren', 'kaufen', 'lernen']
    answerIndex: 1
    explanation: 'Verbs ending in -ieren never take ge-: studieren → studiert, telefonieren → telefoniert.'
  - question: 'How is the Perfekt of the separable verb "aufstehen" (to get up) formed?'
    options: ['geaufstanden', 'aufgestanden', 'aufgestehen', 'gestandenauf']
    answerIndex: 1
...
exercises:
  - type: 'fill-blank'
    ...
    answer: 'habe'
    accepted: ['Habe']
    hint: 'Essen is transitive (it has a direct object, "Pizza"), so it takes haben, not sein.'
  ...
  - type: 'fill-blank'
    ...
    answer: 'ist'
    accepted: ['Ist']
    hint: 'Fahren is a verb of motion — motion and change-of-state verbs take sein.'
    translation: 'He went to Berlin.'
    placeholder: 'hat / ist'
  - type: 'match'
    instructions: 'Match each infinitive with its Perfekt participle.'
    pairs:
      - left: 'machen'
        right: 'gemacht'
      - left: 'gehen'
      ...
      - left: 'aufstehen'
        right: 'aufgestanden'
  - type: 'write'
    prompt: 'Complete the Perfekt sentence: "Wir ___ Deutsch gelernt." (We learned German.)'
    answer: 'haben'
    accepted: ['Haben']
    hint: 'Lernen is a regular, transitive verb — it always pairs with haben.'
    placeholder: 'haben / sind'
  - type: 'write'
    prompt: 'Complete the Perfekt sentence: "Sie ___ um acht Uhr aufgestanden." (She got up at eight o’clock.)'
    answer: 'ist'
    accepted: ['Ist']
    hint: 'Aufstehen is a change-of-state verb (asleep/lying down → up), so it takes sein.'
    placeholder: 'hat / ist'
  - type: 'order'
...
vocabulary:
  - term: 'gemacht'
    translation: 'done / made (participle of machen)'
  - term: 'gegangen'
    translation: 'gone (participle of gehen)'
  - term: 'gegessen'
    translation: 'eaten (participle of essen)'
  - term: 'getrunken'
    translation: 'drunk (participle of trinken)'
  - term: 'gefahren'
    translation: 'driven / traveled (participle of fahren)'
  - term: 'aufgestanden'
    translation: 'got up (participle of aufstehen)'
  - term: 'gewesen'
    translation: 'been (participle of sein)'
  - term: 'geblieben'
    translation: 'stayed (participle of bleiben)'
---

When Germans talk about something that already happened — what they did yesterday, last
...
Perfekt is a two-part ("compound") tense:

```
haben or sein  (conjugated, position 2)  +  past participle  (at the end)
```
...
**Verbs with an inseparable prefix** (be-, ge-, er-, ver-, zer-, ent-, emp-, miss-):
also no ge- prefix, because these prefixes are never separated from the verb:
...
- Sie **ist** um acht Uhr **aufgestanden.** (She got up at eight o'clock.)
- Habt ihr das Buch schon **gelesen?** (Have you already read the book?)

A useful shortcut: if you can picture the verb as "moving somewhere" or "changing from
one state to another," reach for **sein**. Everything else, by default, takes **haben**.
