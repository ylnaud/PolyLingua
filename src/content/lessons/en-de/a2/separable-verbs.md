...
language: 'de'
level: 'a2'
title: 'Separable Verbs (Trennbare Verben): When the Prefix Runs Away'
description: 'Understand German separable verbs like aufstehen and einkaufen, where the prefix jumps to the end of the sentence, plus how they behave in the Perfekt tense.'
order: 3
unit: 1
...
quiz:
  ...
  - question: 'How is the Perfekt participle of "anrufen" (to call) formed?'
    options: ['geanrufen', 'angerufen', 'anrufen gehabt', 'gerufenan']
    answerIndex: 1
  ...
  - question: 'Which sentence is a correct yes/no question using "mitkommen" (to come along)?'
    options: ['Kommst du mit?', 'Mitkommst du?', 'Du mitkommst?', 'Kommst mit du?']
    answerIndex: 0
    explanation: 'In questions, the conjugated verb still comes first and the prefix is still pushed to the end: Kommst du mit?'
exercises:
  - type: 'fill-blank'
    sentence: 'Ich stehe jeden Tag früh ___.'
    answer: 'auf'
    accepted: ['Auf']
    hint: 'Aufstehen splits: stehe stays in position 2, auf goes to the end of the sentence.'
    translation: 'I get up early every day.'
    placeholder: 'auf / an / ein'
  - type: 'fill-blank'
    sentence: 'Er ruft seine Mutter ___.'
    answer: 'an'
    accepted: ['An']
    hint: 'Anrufen splits into ruft ... an — the prefix "an" moves to the end.'
    translation: 'He calls his mother.'
    placeholder: 'an / auf / mit'
  - type: 'match'
    instructions: 'Match each separable verb with its meaning.'
    pairs:
      - left: 'aufstehen'
        right: 'to get up'
      - left: 'einkaufen'
        right: 'to shop'
      - left: 'anrufen'
        right: 'to call (by phone)'
      - left: 'fernsehen'
        right: 'to watch TV'
      - left: 'mitkommen'
        right: 'to come along'
  - type: 'write'
    prompt: 'How do you say "Close the door!" using "zumachen"?'
    answer: 'Mach die Tür zu!'
    accepted: ['Mache die Tür zu!']
    hint: 'Zumachen splits: Mach(e) ... zu, with "zu" at the end of the command.'
    placeholder: 'Mach die Tür ___!'
  - type: 'write'
    prompt: 'Complete: "Wir kaufen im Supermarkt ___." (We shop at the supermarket.)'
    answer: 'ein'
    accepted: ['Ein']
    hint: 'Einkaufen splits into kaufen ... ein.'
    placeholder: 'ein / auf / an'
  - type: 'order'
    sentence: 'Wir kaufen im Supermarkt ein'
    translation: 'We shop at the supermarket.'
vocabulary:
  - term: 'aufstehen'
    translation: 'to get up'
  - term: 'einkaufen'
    translation: 'to shop, to buy groceries'
  - term: 'anrufen'
  ...
  - term: 'besuchen'
    translation: 'to visit (inseparable — never splits)'
---
...
- **Sie sehen abends fern.** (They watch TV in the evening.)
- **Kommst du mit?** (Are you coming along? — questions still push the prefix to the end.)
- **Mach die Tür auf!** / **Mach die Tür zu!** (Open the door! / Close the door! — same
  rule applies to commands.)

## Separable verbs vs. inseparable verbs

Not every prefix behaves this way. A small, fixed set of prefixes are **inseparable**
and NEVER split off: **be-, ge-, er-, ver-, zer-, ent-, emp-, miss-**.

- **besuchen** (to visit) → **Ich besuche meine Oma.** (never "Ich suche meine Oma be")
