...
quiz:
  ...
  - question: 'Which sentence correctly reports "Ich bin müde" (she said) in Konjunktiv I?'
    options: ['Sie sagte, sie ist müde.', 'Sie sagte, sie sei müde.', 'Sie sagte, sie wäre müde.']
    answerIndex: 1
  ...
  - question: 'Which introductory verb typically triggers Konjunktiv I in the clause that follows?'
    options: ['behaupten, erklären, berichten', 'können, dürfen, müssen', 'werden, sein, haben']
    answerIndex: 0
...
exercises:
  - type: 'fill-blank'
    sentence: 'Der Sprecher sagte, die Regierung ___ das Gesetz bald verabschieden. (Konjunktiv I of werden)'
    answer: 'werde'
    accepted: ['werde']
    hint: 'Konjunktiv I of werden, 3rd person singular: ich werde, du werdest, er/sie/es werde.'
    translation: 'The spokesperson said the government would pass the law soon.'
    placeholder: 'werde / würde / wird'
  - type: 'fill-blank'
    sentence: 'Sie behauptete, sie ___ krank. (Konjunktiv I of sein)'
    answer: 'sei'
    accepted: ['sei']
    hint: 'sein is irregular in Konjunktiv I: ich sei, du sei(e)st, er/sie/es sei, wir seien, ihr seiet, sie seien.'
    translation: 'She claimed she was sick.'
    placeholder: 'sei / ist / wäre'
  - type: 'match'
    instructions: 'Match each Konjunktiv I form of sein with its pronoun.'
    pairs:
      - left: 'ich'
        right: 'sei'
      - left: 'du'
  ...
  - type: 'write'
    prompt: 'Why would "Er sagte, sie kommen morgen." fail as clear reported speech, and what should replace "kommen"?'
    answer: 'kämen'
    accepted: ['kämen', 'sie kämen', 'weil kommen identisch mit dem Indikativ ist']
    hint: 'Konjunktiv I of kommen for sie (plural) is identical to the indicative form, so German switches to Konjunktiv II: kämen.'
    placeholder: 'kämen'
  - type: 'order'
    sentence: 'Der Minister erklärte die Reform werde bald verabschiedet'
    translation: 'The minister explained that the reform would be passed soon.'
vocabulary:
  - term: 'die indirekte Rede'
    translation: 'reported/indirect speech'
  - term: 'behaupten'
  ...
  - term: 'sei / seien'
    translation: 'Konjunktiv I of sein (to be)'
  - term: 'habe / haben'
    translation: 'Konjunktiv I of haben (to have)'
  - term: 'werde / werden'
...
## What Konjunktiv I actually signals

Konjunktiv I does not express a wish, a hypothetical, or politeness (that is Konjunktiv II's
...
## Forming Konjunktiv I in the present
...
- ~~Er sagte, sie kommen morgen.~~ → **Er sagte, sie kämen morgen.**
- ~~Sie berichteten, sie haben keine Zeit.~~ → **Sie berichteten, sie hätten keine Zeit.**
- ~~Die Firma erklärte, sie schließen die Filiale.~~ → **Die Firma erklärte, sie würden die
  Filiale schließen.**

Rule of thumb: whenever the Konjunktiv I form is indistinguishable from the indicative, reach
for Konjunktiv II instead. This is a real grammatical rule, not a stylistic preference — native
writers apply it automatically.

## Reporting the past: only one past tense exists
...
## Where you will meet Konjunktiv I
