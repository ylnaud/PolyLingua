...
quiz:
  - question: "What is the key difference between 'sich freuen auf' and 'sich freuen über'?"
    options:
      - "'sich freuen auf' + Akkusativ looks forward to something in the future; 'sich freuen über' + Akkusativ expresses joy about something that has already happened or is present"
      - 'They are fully interchangeable with no difference in meaning'
      - "'sich freuen auf' is used only in writing, 'sich freuen über' only in speech"
    answerIndex: 0
    explanation: "'Ich freue mich auf die Ferien' (I'm looking forward to the holidays, future) versus 'Ich freue mich über das Geschenk' (I'm happy about the gift, already received) — the choice of preposition marks a real difference in time and meaning that no general grammar rule predicts."
  - question: "Why can't the case-and-preposition rules taught at lower levels (e.g. 'auf + Akkusativ = movement onto something') fully explain a phrase like 'warten auf'?"
    options:
  ...
  - question: "'Ich denke an dich' uses 'an' + Akkusativ. What does this phrase mean, and why does 'an' appear here rather than another preposition?"
    options:
      - "'I am thinking of/about you' — 'denken an' is simply the fixed collocation for this verb, unrelated to any literal spatial meaning of 'an'"
      - "'I am standing next to you', using 'an' in its literal spatial sense"
      - "'I owe you money', an idiom unrelated to thinking"
    answerIndex: 0
    explanation: "'Denken an' (+ Akkusativ) is the fixed pairing for 'to think of/about' — like 'sich freuen auf/über' and 'warten auf,' it must be memorized as a chunk rather than derived from general preposition rules."
  - question: "What does 'sich interessieren für' mean, and what case does 'für' take here?"
    options:
      - "'to be interested in,' with 'für' + Akkusativ (as für always requires)"
      - "'to be afraid of,' with für + Dativ"
      - "'to argue for,' used only in debates"
    answerIndex: 0
    explanation: "'Sich interessieren für' + Akkusativ means 'to be interested in' — für always triggers Akkusativ regardless of context, but which preposition pairs with 'interessieren' at all is still a fact you must memorize with the verb."
  - question: "A learner says 'Ich warte für den Bus' instead of the correct 'Ich warte auf den Bus.' What kind of mistake is this?"
    options:
      - 'A spelling mistake only'
      - "A classic idiomatic-preposition error — likely influenced by English 'wait FOR,' since the German fixed collocation actually requires 'auf,' not 'für'"
...
exercises:
  - type: 'fill-blank'
    ...
    accepted:
      - 'auf'
    hint: "Looking forward to something in the future uses 'sich freuen auf' + Akkusativ, not 'über'."
    translation: "I'm already looking forward to the holidays next week."
    placeholder: 'über'
  - type: 'fill-blank'
    sentence: 'Sie wartet seit einer Stunde ___ den Bus.'
    answer: 'auf'
    accepted:
      - 'auf'
    hint: "'Warten' pairs fixedly with 'auf' + Akkusativ, unlike English 'wait FOR'."
    translation: "She's been waiting for the bus for an hour."
    placeholder: 'für'
  - type: 'match'
    instructions: 'Match each German verb-preposition pair with its meaning.'
    pairs:
      - left: 'sich freuen auf + Akk.'
        right: 'to look forward to (future)'
      - left: 'sich freuen über + Akk.'
        right: 'to be happy about (already happened)'
      - left: 'warten auf + Akk.'
        right: 'to wait for'
      - left: 'denken an + Akk.'
        right: 'to think of/about'
      - left: 'sich interessieren für + Akk.'
        right: 'to be interested in'
  - type: 'write'
    prompt: "Fill in the correct preposition: 'Ich denke oft ___ meine Kindheit.' (I often think about my childhood.)"
    answer: 'an'
    accepted:
      - 'An'
    hint: "'Denken' fixedly pairs with this preposition, unrelated to its literal spatial meaning."
    placeholder: 'über'
  - type: 'write'
    prompt: "Translate, being careful with the idiomatic preposition: 'She is interested in German literature.'"
    answer: 'Sie interessiert sich für deutsche Literatur.'
    accepted:
      - 'Sie interessiert sich für die deutsche Literatur'
    hint: "'Sich interessieren' fixedly takes 'für' + Akkusativ, not 'an' or 'in' as English might suggest."
  - type: 'order'
    sentence: 'Ich freue mich schon auf die Ferien'
    translation: "I'm already looking forward to the holidays"
vocabulary:
  - term: 'sich freuen auf + Akk.'
    translation: 'to look forward to (future event)'
  - term: 'sich freuen über + Akk.'
    translation: 'to be happy/glad about (something already happened)'
  - term: 'warten auf + Akk.'
    translation: 'to wait for'
  - term: 'denken an + Akk.'
    translation: 'to think of, about'
  - term: 'sich interessieren für + Akk.'
    translation: 'to be interested in'
  - term: 'die feste Verbindung'
    translation: 'fixed expression, collocation'
  - term: 'sich erinnern an + Akk.'
    translation: 'to remember, recall'
---
...
memorized as a single chunk, because no spatial or logical rule predicts them.
...
preposition isn't chosen for its literal spatial meaning — it's simply the
preposition convention has assigned to that particular verb.

## sich freuen auf vs. sich freuen über: a real distinction
...
timeline of what you're describing.

## The classic English-interference trap: warten auf, not warten für
...
it lines up. At C2, this precision — getting the "small," unglamorous prepositions
exactly right — is often what separates very good German from native-sounding German.
