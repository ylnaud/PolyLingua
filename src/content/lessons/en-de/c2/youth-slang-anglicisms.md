...
quiz:
  ...
  - question: "In German youth slang, what does 'Digga' (or 'Dicka') mean, and to whom is it typically said?"
    options:
      - 'A formal title used to address teachers'
      - "An informal, friendly term of address roughly like 'dude' or 'bro,' used casually among peers"
      - 'A word exclusively used to express anger'
    answerIndex: 1
    explanation: "'Digga' (originating in youth and hip-hop slang, sometimes spelled Dicka) functions like 'dude' or 'bro' in English — an informal, friendly way to address a friend, definitely not appropriate in formal contexts."
  - question: "What does it mean if a German teenager describes a situation as 'cringe'?"
    options:
      - 'That the situation was awkward or embarrassing to witness'
      - 'That the situation was extremely exciting'
      - 'That someone is physically injured'
    answerIndex: 0
    explanation: "'Cringe' has been borrowed directly from English into German youth speech with the same meaning: something so awkward or second-hand embarrassing it makes you want to look away."
  ...
  - question: "What social risk does a non-native speaker face when trying to use current youth slang like 'Digga' or 'cringe' in the wrong context?"
    options:
      - 'None — slang is always appropriate in every setting'
...
exercises:
  - type: 'fill-blank'
    ...
    accepted:
      - 'chillen'
    hint: 'The English verb "to chill" has been fully naturalized into German with a standard infinitive ending.'
    translation: "Let's just chill tonight, no stress."
    placeholder: 'entspannen'
  - type: 'fill-blank'
    sentence: 'Alter, das ist ja richtig ___!'
    answer: 'krass'
    accepted:
      - 'krass'
    hint: 'This flexible intensifier can mean either impressively great or shockingly bad, depending on tone.'
    translation: "Dude, that's really intense/wild!"
    placeholder: 'nett'
  - type: 'match'
    instructions: 'Match each slang term with its meaning.'
    pairs:
      - left: 'Digga'
        right: 'dude / bro (casual address)'
      - left: 'chillen'
        right: 'to chill, relax'
      - left: 'cringe'
        right: 'awkward, embarrassing to witness'
      - left: 'krass'
        right: 'intense, extreme (good or bad)'
      - left: 'Alter'
        right: 'dude / man (casual exclamation or address)'
  - type: 'write'
    prompt: "What is the past participle (Partizip II) of the German-ified verb 'chillen,' following normal weak-verb rules?"
    answer: 'gechillt'
    accepted:
      - 'gechillt'
    hint: 'Add the standard ge- prefix and -t ending used for regular (weak) German verbs.'
  - type: 'write'
    prompt: "Translate into English: 'Das war voll cringe, Alter.'"
    answer: 'That was so cringe, dude'
    accepted:
      - 'That was really embarrassing, man'
      - 'That was totally cringe, dude'
    hint: '"Cringe" keeps its English meaning; "Alter" here is a casual form of address, not literally "old man."'
  - type: 'order'
    sentence: 'Digga das ist doch total krass'
    translation: "Dude, that's totally intense (an exclamation using youth slang and a modal particle for emphasis)"
vocabulary:
  - term: 'Digga / Dicka'
    translation: 'dude, bro (casual address among peers)'
  - term: 'chillen'
    translation: 'to chill, relax (English loanword with German conjugation)'
  - term: 'cringe'
    translation: 'cringeworthy, embarrassing to witness (borrowed directly from English)'
  - term: 'krass'
    translation: 'intense, extreme, wild (can be positive or negative)'
  - term: 'Alter'
    translation: 'dude, man (casual exclamation or address, lit. "old man")'
  - term: 'das Anglizismus'
    translation: 'anglicism, English loanword'
  - term: 'die Jugendsprache'
    translation: 'youth slang'
---

Open any German teenager's group chat and you'll see something textbooks rarely
...
compatible underlying patterns — and German's system of verb endings and noun
genders is productive enough to bolt onto almost any borrowed root.

## The core vocabulary of Jugendsprache
...
Using **Digga** with your professor, or **cringe** in a formal email, doesn't just
sound informal — it can land as strange or try-hard, because slang is tightly bound
to age group, peer group, and setting. The skill isn't only knowing the words; it's
knowing exactly where they belong (a friend's WhatsApp chat) and where they very much
don't (a cover letter).

## Why this vocabulary won't stay still

Slang is the fastest-aging part of any language. Words that felt cutting-edge five
years ago can already sound dated to current teenagers — this is true in English too
("that's so fetch" never quite happened, and plenty of once-current slang now sounds
like a time capsule). There's no fixed list to memorize once and be done; staying
current means ongoing exposure to German social media, youth-oriented shows, and
conversations with younger native speakers, treating slang as a living, moving
target rather than a finished vocabulary set.
