...
entendiste, o cuando la embarraste.

## Cuando algo no anda

```
Das funktioniert nicht.           Esto no funciona.
Meine Waschmaschine ist kaputt.   Mi lavarropas está roto.
...
Können Sie bitte langsamer sprechen?     ¿Puede hablar más despacio?
Wie sagt man das auf Deutsch?            ¿Cómo se dice esto en alemán?
```

Estas cuatro valen más que cien palabras de vocabulario. Pedir que te repitan es lo que
te permite **seguir** la conversación en vez de asentir sin entender nada.

Fijate la estructura de `können`: el verbo conjugado va segundo y el infinitivo se va
**al final**.
...
```
Ich habe meinen Schlüssel verloren.   Perdí mi llave.
Ich habe mich verspätet.              Se me hizo tarde.
...
Memorizá primero **`Können Sie das bitte wiederholen?`** hasta que te salga automática,
antes que cualquier otra frase de esta lección. Es la que más te va a servir en una
conversación real, porque es la que evita que la conversación se corte.
