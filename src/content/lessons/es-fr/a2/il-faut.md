...
"il" no se refiere a nadie en particular, es solo el sujeto gramatical fijo de la
fórmula.

## il faut: la obligación general

```
il faut + infinitivo         (obligación general, sin sujeto específico)

Il faut manger pour vivre.      (Hay que comer para vivir)
Il faut être patient.            (Hay que ser paciente)
```

## il faut que + subjonctif: con sujeto específico

Cuando quieres señalar A QUIÉN le corresponde la obligación, necesitas "que" + sujeto +
subjonctif:

```
Il faut que tu partes maintenant.
(Tienes que irte ahora — nota el subjonctif "partes")
```
...
Il y a trois livres ici.       (Hay tres libros aquí)
...
"Il faut" es tu herramienta para dar consejos generales sin sonar demasiado directo
("tienes que...") — mucho más natural y frecuente en francés que decir "tu dois" para
cada recomendación cotidiana.
