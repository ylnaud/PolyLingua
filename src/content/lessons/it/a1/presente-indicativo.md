...
igual que el español — así que la lógica general ya la conoces.
...
Fíjate cómo **noi siempre termina en -iamo** en los tres grupos — es tu ancla, la
terminación más fácil de recordar porque nunca cambia entre grupos.

## Un aviso amistoso: essere y avere

Como en casi todos los idiomas romances, "essere" (ser/estar) y "avere" (tener) son
irregulares y aparecen constantemente:

```
io sono (soy/estoy)     io ho (tengo)
tu sei                   tu hai
lui/lei è                lui/lei ha
```

Vale la pena memorizarlos ya, porque los necesitarás en tu próxima lección para formar
el pasado.
