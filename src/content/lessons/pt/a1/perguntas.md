...
cualquier conversación real.

## Preguntas de sí/no: solo cambia la entonación

```
Afirmación:   Você fala português.
Pregunta:      Você fala português?
```

El orden de palabras no cambia — solo la entonación ascendente al final (y el signo de
...
## "Por que" vs. "porque": cuatro formas, cuidado

```
Por que você foi embora?     (¿Por qué te fuiste? — pregunta)
Porque eu estava cansado.     (Porque yo estaba cansado — respuesta)
```

Existen también "por quê" (final de pregunta, con acento) y "porquê" (sustantivo: "o
porquê" = el porqué) — pero estos dos casos son menos frecuentes al empezar.
